...
class Reserve extends Component {
	...
	render() {
		return (
			<ImageBackground source={require('../assets/images/bgBlue.png')} style={{ width: '100%', height: '100%' }}>
				<TouchableOpacity
				...
				<KeyboardAvoidingView behavior="padding" enabled style={styles.container}>
					...
					<View style={styles.inputWrapper}>
						...
						<TextInput
							...
							selectionColor="#fff"
							onFocus={() => {
								this.setState({ modalVisible: true, isFrom: true });
							}}
					...
					<View style={styles.inputWrapper}>
						...
						<TextInput
							...
							selectionColor="#fff"
							onFocus={() => {
								this.setState({ modalVisible: true, isFrom: false });
							}}
					...
					>
						<View style={{ flex: 1, marginTop: 30 }}>
							<GooglePlacesAutocomplete
								placeholder={
									this.state.isFrom ? 'Select your pickup location' : 'Select your dropoff location'
								}
								minLength={3}
								autoFocus={true}
								...
								getDefaultValue={() => ''}
								query={{
									key: 'AIzaSyAxR59Ubk9XN44ubSy73X35RqXp_vguqHo',
									language: 'en',
									types: '(cities)',
								}}
